...
Public Sub Test_LibraryString()
    ...
    Call AssertFalse("StringBool() - empty", StringBool(""))
    ...
    Call AssertTrue("ValidStringBool - Yes", ValidStringBool("true"))
...
Public Function StringBool(AInput As String) As Boolean
    Dim sInput As String
    
    sInput = LCase(Trim(AInput))
    
    StringBool = (sInput = "true") Or (sInput = "yes")
End Function

Public Function BoolString(AInput As Boolean) As String
    BoolString = IIf(AInput, "True", "False")
End Function

Public Function ValidStringBool(AInput As String) As Boolean
    Dim sInput As String
    
    sInput = LCase(Trim(AInput))
    
    ValidStringBool = (sInput = "true") Or (sInput = "yes") Or (sInput = "false") Or (sInput = "no")
End Function
